...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.reservation.title_form') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.reservations.store") }}" enctype="multipart/form-data" id="reservationForm">
            @csrf
            <fieldset>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group my-2">
                            ...
                            <input class="form-control {{ $errors->has('check_in_date') ? 'is-invalid' : '' }}" type="date" name="check_in_date" id="check_in_date" value="{{ old('check_in_date', '') }}">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group my-2">
                            ...
                            <input class="form-control {{ $errors->has('check_out_date') ? 'is-invalid' : '' }}" type="date" name="check_out_date" id="check_out_date" value="{{ old('check_out_date', '') }}">
                        ...
                        <div class="form-group my-2">
                            ...
                            <select class="form-control select2 {{ $errors->has('check_in_time') ? 'is-invalid' : '' }}"
                                ...
                                @foreach (App\Models\Reservation::TIME as $key => $label)
                                    <option value="{{ $key }}"
                                        {{ old('check_in_time', '') === (string) $key ? 'selected' : '' }}>{{ $label }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group my-2">
                            ...
                            <select class="form-control select2 {{ $errors->has('check_out_time') ? 'is-invalid' : '' }}"
                                ...
                                @foreach (App\Models\Reservation::TIME as $key => $label)
                                    <option value="{{ $key }}"
                                        {{ old('check_out_time', '') === (string) $key ? 'selected' : '' }}>{{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group my-2">
                            ...
                            <select class="form-control select2 {{ $errors->has('no_of_adults') ? 'is-invalid' : '' }}"
                                ...
                                <option value>
                                    ...
                                    <option value="1"
                                        {{ old('no_of_adults', '') === 1 ? 'selected' : '' }}> 1
                                    </option>
                                    <option value="2"
                                        {{ old('no_of_adults', '') === 2 ? 'selected' : '' }}> 2
                                    </option>
                                    <option value="3"
                                        {{ old('no_of_adults', '') === 3 ? 'selected' : '' }}> 3
                                    </option>
                                    <option value="4"
                                        {{ old('no_of_adults', '') === 4 ? 'selected' : '' }}> 4
                                    </option>
                                    <option value="5"
                                        {{ old('no_of_adults', '') === 5 ? 'selected' : '' }}> 5
                                    </option>
                            </select>
                        ...
                        <div class="form-group my-2">
                            ...
                            <select class="form-control select2 {{ $errors->has('no_of_children') ? 'is-invalid' : '' }}"
                                ...
                                <option value>
                                    ...
                                    <option value="0"
                                        {{ old('no_of_children', '') === 0 ? 'selected' : '' }}> 0
                                    </option>
                                    <option value="1"
                                        {{ old('no_of_children', '') === 1 ? 'selected' : '' }}> 1
                                    </option>
                                    <option value="2"
                                        {{ old('no_of_children', '') === 2 ? 'selected' : '' }}> 2
                                    </option>
                                    <option value="3"
                                        {{ old('no_of_children', '') === 3 ? 'selected' : '' }}> 3
                                    </option>
                                    <option value="4"
                                        {{ old('no_of_children', '') === 4 ? 'selected' : '' }}> 4
                                    </option>
                                    <option value="5"
                                        {{ old('no_of_children', '') === 5 ? 'selected' : '' }}> 5
                                    </option>
                            </select>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-group my-2">
                            ...
                            <input class="form-control {{ $errors->has('no_of_rooms') ? 'is-invalid' : '' }}" type="number" name="no_of_rooms" id="no_of_rooms" value="{{ old('no_of_rooms', '') }}">
                        ...
                        <div class="form-group my-2">
                            ...
                            <select class="form-control select2 {{ $errors->has('room_1_type') ? 'is-invalid' : '' }}"
                                ...
                                @foreach (App\Models\Reservation::ROOM as $key => $label)
                                    <option value="{{ $key }}"
                                        {{ old('room_1_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group my-2">
                            ...
                            <select class="form-control select2 {{ $errors->has('room_2_type') ? 'is-invalid' : '' }}"
                                ...
                                @foreach (App\Models\Reservation::ROOM as $key => $label)
                                    <option value="{{ $key }}"
                                        {{ old('room_2_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-group my-2">
                            ...
                            <textarea rows="4" class="form-control {{ $errors->has('instructions') ? 'is-invalid' : '' }}" name="instructions" id="instructions">{!! old('instructions') !!}</textarea>
